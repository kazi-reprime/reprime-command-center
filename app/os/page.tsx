...
export default function OSLayerPage() {
  return (
    <div className="min-h-screen bg-background flex flex-col font-sans items-center justify-center p-6">
      <div className="w-full max-w-md bg-surface border border-border rounded-xl p-8 flex flex-col items-center shadow-2xl text-center">
        ...
        <div className="mb-6 flex flex-col items-center">
          <div className="w-12 h-12 rounded-full bg-accent/20 border border-accent/40 flex items-center justify-center mb-4">
