...
export default function OSLayerPage() {
  return (
    <div className="min-h-screen bg-[#08224d] flex flex-col font-sans items-center justify-center p-6">
      <div className="w-full max-w-md bg-zinc-950 border border-zinc-800 rounded-xl p-8 flex flex-col items-center shadow-2xl text-center">
        ...
        <div className="mb-6 flex flex-col items-center">
          ...
          <h1 className="text-xl font-bold text-white mb-2 tracking-wide">OS Advanced Modules has moved</h1>
        ...
        <a 
          ...
          className="w-full mb-4 px-4 py-3 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg font-bold text-sm tracking-wide transition-colors flex justify-center items-center gap-2 shadow-[0_0_15px_rgba(16,185,129,0.3)]"
        >
        ...
        <Link href="/cockpit" className="text-sm text-zinc-500 hover:text-zinc-300 font-mono transition-colors">
